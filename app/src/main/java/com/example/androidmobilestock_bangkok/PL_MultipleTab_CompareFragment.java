...
import com.example.androidmobilestock_bangkok.databinding.PlFragmentMultipletabCompareBinding;

import java.util.ArrayList;
import java.util.List;

public class PL_MultipleTab_CompareFragment extends Fragment {
    ACDatabase db;
    ListView listview;
    PlFragmentMultipletabCompareBinding binding;
    ...
    public PL_MultipleTab_CompareFragment() {
        // Required empty public constructor
    }

    public static PL_MultipleTab_CompareFragment newInstance(Bundle myBundle) {
        PL_MultipleTab_CompareFragment fragment = new PL_MultipleTab_CompareFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.pl_fragment_multipletab_compare, container, false);
