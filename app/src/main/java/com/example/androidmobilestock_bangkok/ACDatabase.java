...
import com.example.androidmobilestock_bangkok.ui.main.Hash;
...
//        db.execSQL(query_editUser2);
        ...
        db.execSQL("ALTER TABLE Item ADD COLUMN UDF_UDF1 VARCHAR(50)");
        db.execSQL("ALTER TABLE Item ADD COLUMN UDF_UDF2 VARCHAR(50)");
        db.execSQL("ALTER TABLE Item ADD COLUMN UDF_UDF3 VARCHAR(50)");
        db.execSQL("ALTER TABLE Item ADD COLUMN UDF_UDF4 VARCHAR(50)");
        db.execSQL("ALTER TABLE Item ADD COLUMN UDF_UDF5 VARCHAR(50)");
        db.execSQL("ALTER TABLE Users ADD COLUMN CustomA INTEGER DEFAULT 0 NOT NULL");
        db.execSQL("ALTER TABLE Users ADD COLUMN CustomB INTEGER DEFAULT 0 NOT NULL");
        db.execSQL("INSERT INTO REG (ID, Value) VALUES ('75','0')");
        db.execSQL("INSERT INTO REG (ID, Value) VALUES ('76','0')");
    }
...
//        }
    ...
    // Reset INV
    public boolean resetINV()
    {
        SQLiteDatabase database = this.getWritableDatabase();
        int sqlResult = database.delete("Sales", null, null);
        int sqlResult1 = database.delete(TABLE_NAME_INV_DTL, null, null);
        int sqlResult2 = database.delete(TABLE_NAME_PAYMENT, null, null);
        return (sqlResult > 0 && sqlResult1 >= 0 && sqlResult2 >= 0);
    }
    ...
    public boolean insertUsers(String UsernameFP, String PwdFP, Boolean EnableSettingFP, Boolean FilterByAgentFP, Boolean SalesFP, Boolean PurchaseFP, Boolean TransferFP, Boolean PackingListFP, Boolean CatalogFP, Boolean CollectionFP, Boolean StockAssemblyFP, Boolean AnalyticsFP, Boolean StockTakeFP, Boolean SellingPriceFP, Boolean PurchasePackingListFP, Boolean StockInquiryFP, Boolean CostFP, Boolean JobSheetFP, Boolean StockReceiveFP, Boolean CustomAFP, Boolean CustomBFP) {
        ...
        cv.put("CustomA", boolToInt(CustomAFP));
        cv.put("CustomB", boolToInt(CustomBFP));
...
//        Log.i("custDebug",DatabaseUtils.dumpCursorToString(db.rawQuery("SELECT *  FROM "+TABLE_NAME_DEBTOR, null)));
    ...
    public boolean insertItem(String ItemCode, String Description, String Desc2, String ItemGroup,
                              ...
                              String hasBatchno, String SalesUOM, String PurchaseUOM, String IsSalesItem, String IsPurchaseItem, String IsRawMaterialItem, String IsFinishGoodsItem, String UDF_UDF1, String UDF_UDF2, String UDF_UDF3, String UDF_UDF4, String UDF_UDF5) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        ...
        cv.put("UDF_UDF1", UDF_UDF1);
        cv.put("UDF_UDF2", UDF_UDF2);
        cv.put("UDF_UDF3", UDF_UDF3);
        cv.put("UDF_UDF4", UDF_UDF4);
        cv.put("UDF_UDF5", UDF_UDF5);
...
//    }
    ...
    public Cursor getItemLike(String substring, int mode, String INCLAUSE) {
        ...
        switch (mode) {
            //All UOM
            case 0:
                data = database.rawQuery("SELECT b.ItemCode, b.ItemCode2, a.UOM, b.Description, b.Desc2, b.ItemGroup, b.ItemType, b.TaxType, b.PurchaseTaxType, b.BaseUOM, a.Price, a.Price2, a.Price3, a.Price4, a.Price5, a.Price6, a.BarCode, a.Shelf, a.Rate, a.MinPrice, a.MaxPrice, b.HasBatchNo, b.UDF_UDF1, b.UDF_UDF2, b.UDF_UDF3, b.UDF_UDF4, b.UDF_UDF5 FROM ItemUOM a JOIN Item b ON a.ItemCode=b.ItemCode WHERE (a.BarCode LIKE ? OR b.ItemCode LIKE ? OR b.Description LIKE ?  OR b.Desc2 LIKE ?) " + INCLAUSE  , new String[]{"%" + substring + "%", "%" + substring + "%", "%" + substring + "%", "%" + substring + "%"});
                break;
            //BaseUOM
            case 1:
                data = database.rawQuery("SELECT b.ItemCode,b.ItemCode2, BaseUOM, b.Description, b.Desc2, b.ItemGroup, b.ItemType, b.TaxType, b.PurchaseTaxType, b.BaseUOM, b.Price, b.Price2, a.Price3, a.Price4, a.Price5, a.Price6, b.BarCode, a.Shelf, a.Rate, a.MinPrice, a.MaxPrice, b.HasBatchNo, b.UDF_UDF1, b.UDF_UDF2, b.UDF_UDF3, b.UDF_UDF4, b.UDF_UDF5 FROM Item b JOIN ItemUOM a ON a.ItemCode=b.ItemCode AND a.UOM = b.BaseUOM WHERE (b.BarCode LIKE ? OR b.ItemCode LIKE ? OR b.Description LIKE ? OR b.Desc2 LIKE ?  ) "+ INCLAUSE, new String[]{"%" + substring + "%", "%" + substring + "%", "%" + substring + "%", "%" + substring + "%"});
                break;
            case 3:
                data = database.rawQuery("SELECT b.ItemCode, b.Description, b.Desc2, b.ItemGroup, b.ItemType, b.TaxType, b.PurchaseTaxType , a.UOM AS BaseUOM, a.Price, a.Price2, a.BarCode, b.ItemCode2, b.UDF_UDF1, b.UDF_UDF2, b.UDF_UDF3, b.UDF_UDF4, b.UDF_UDF5 FROM ItemUOM a JOIN Item b ON a.ItemCode=b.ItemCode WHERE (a.BarCode = ? ) " + INCLAUSE, new String[]{substring});

                if (data.getCount() == 0) {
                    data = database.rawQuery("SELECT b.ItemCode, b.Description, b.Desc2, b.ItemGroup, b.ItemType, b.TaxType, b.PurchaseTaxType , b.baseUOM, a.Price, a.Price2, a.BarCode, b.ItemCode2, b.UDF_UDF1, b.UDF_UDF2, b.UDF_UDF3, b.UDF_UDF4, b.UDF_UDF5 FROM ItemUOM a JOIN Item b ON a.ItemCode=b.ItemCode AND a.UOM=b.BaseUOM WHERE a.ItemCode = ? " + INCLAUSE, new String[]{substring});
                }
                break;

                //SalesUOM
            case 4:
                data = database.rawQuery("SELECT b.ItemCode, b.ItemCode2, b.SalesUOM, b.Description, b.Desc2, b.ItemGroup, b.ItemType, b.TaxType, b.PurchaseTaxType, b.BaseUOM, a.Price, a.Price2, a.Price3, a.Price4, a.Price5, a.Price6, a.BarCode, a.Shelf, a.Rate, a.MinPrice, a.MaxPrice, b.HasBatchNo, b.UDF_UDF1, b.UDF_UDF2, b.UDF_UDF3, b.UDF_UDF4, b.UDF_UDF5 FROM ItemUOM a JOIN Item b ON a.ItemCode=b.ItemCode  AND a.UOM = b.SalesUOM WHERE IsSalesItem = 'true' AND  (b.BarCode LIKE ? OR b.ItemCode LIKE ? OR b.Description LIKE ? OR b.Desc2 LIKE ? ) " + INCLAUSE, new String[]{"%" + substring + "%", "%" + substring + "%", "%" + substring + "%", "%" + substring + "%"});
                break;

                //PurchaseUOM
            case 5:
                data = database.rawQuery("SELECT b.ItemCode, b.ItemCode2, b.PurchaseUOM, b.Description, b.Desc2, b.ItemGroup, b.ItemType, b.TaxType, b.PurchaseTaxType, b.BaseUOM, b.Price, b.Price2, a.Price3, a.Price4, a.Price5, a.Price6, a.BarCode, a.Shelf, a.Rate, a.MinPrice, a.MaxPrice, b.HasBatchNo, b.UDF_UDF1, b.UDF_UDF2, b.UDF_UDF3, b.UDF_UDF4, b.UDF_UDF5 FROM ItemUOM a JOIN Item b ON a.ItemCode=b.ItemCode  AND a.UOM = b.PurchaseUOM WHERE IsPurchaseItem = 'true' AND  (b.BarCode LIKE ? OR b.ItemCode LIKE ? OR b.Description LIKE ? OR b.Desc2 LIKE ? ) " + INCLAUSE, new String[]{"%" + substring + "%", "%" + substring + "%", "%" + substring + "%", "%" + substring + "%"});
                break;
    ...
    public Cursor getItemUOM(String ItemCode, String UOM)
    {
        SQLiteDatabase database = this.getReadableDatabase();
        Cursor data = database.rawQuery("SELECT * FROM  ItemUOM WHERE ItemCode =? AND UOM=?" , new String[]{ItemCode, UOM});
        return data;
    }
...
//    }
    ...
    {
        SQLiteDatabase database = this.getReadableDatabase();
        Cursor data = database.rawQuery("SELECT SalesDtl.Qty FROM Sales JOIN SalesDtl ON Sales.DocNo = SalesDtl.DocNo WHERE Sales.Uploaded=0 AND ItemCode=? AND UOM=? AND Location=?", new String[]{stockBalance.getItemCode(), stockBalance.getUOM(), stockBalance.getLocation()});
        if (data.moveToNext()) {
            return data.getFloat(0);
        } else {
            return 0.00f;
...
//    }
    ...
    {
        SQLiteDatabase database = this.getReadableDatabase();
        Cursor data = database.rawQuery("SELECT SalesDtl.* FROM Sales JOIN SalesDtl ON Sales.DocNo = SalesDtl.DocNo WHERE Sales.Uploaded=0 AND ItemCode=? AND UOM=?", new String[]{ItemCode, UOM});
...
//    }
    ...
    public Cursor getHistoryPriceByDebtorByAgent(String ItemCode, String UOM, String DebtorCode, String Agent)
    {
        ...
        Cursor data = database.rawQuery("SELECT * FROM HistoryPrice a JOIN Debtor b ON a.AccNo = b.AccNo WHERE a.ItemCode =? AND a.UOM=? AND a.AccNo=? AND Agent=?", new String[]{ItemCode, UOM, DebtorCode, Agent});
...
//    }
    ...
    public Cursor getHistoryPriceByAgentLike(String ItemCode, String UOM, String DebtorName, String Agent)
    {
        ...
        Cursor data = database.rawQuery("SELECT * FROM HistoryPrice a JOIN Debtor b ON a.AccNo = b.AccNo WHERE a.ItemCode =? AND a.UOM=? AND CompanyName LIKE ? AND Agent=?", new String[]{ItemCode, UOM, "%"+DebtorName+"%", Agent});
...
//                break;
    ...
    {
        SQLiteDatabase database = this.getReadableDatabase();
        Cursor data = database.rawQuery("SELECT Sales.*, Debtor.Address1, Debtor.Address2, Debtor.Address3, Debtor.Address4 FROM Sales INNER JOIN Debtor ON Sales.DebtorCode=Debtor.AccNo WHERE DocNo =?", new String[]{docNo});
        return data;
    }
...
//            myST.setRemarks(header.getString(header.getColumnIndex("Remarks")));
    ...
    public boolean deleteStockCount(String itemcode) {
        boolean result = false;
        String[] arg = {itemcode};
        SQLiteDatabase database = this.getWritableDatabase();
        int sqlResult = database.delete(TABLE_NAME_SC, "ItemCode =?", arg);
        if (sqlResult > 0) {
            result = true;
        }
        return result;
    ...
    public void UpdateStockCount(AC_Class.StockCount stockCount) {
        ...
        cv.put(COL7_SC, stockCount.Exported);
