...
import com.example.androidmobilestock_bangkok.databinding.RowSettingsListBinding;
...
//    private SettingsClass[] settings_list;
    ...
    public SettingsListViewAdapter(Context context, String[] title_list, int[] icon_list, String[] subtitle_list) {
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RowSettingsListBinding binding;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.row_settings_list, null);
            binding = DataBindingUtil.bind(convertView);
            convertView.setTag(binding);
        } else {
            binding = (RowSettingsListBinding) convertView.getTag();
        }
