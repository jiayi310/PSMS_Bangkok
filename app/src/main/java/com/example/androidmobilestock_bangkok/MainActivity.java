...
import com.example.androidmobilestock_bangkok.Settings.SettingsHome;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment_container, new com.example.androidmobilestock_bangkok.Menu()).commit();
    ...
    protected void onResume() {
        ...
        if (currentFragment instanceof com.example.androidmobilestock_bangkok.Menu) {
            BottomNavigationView bottomnav = findViewById(R.id.bottomNavigationView);
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener navListener = new BottomNavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.menu:
                    selectedFragment = new com.example.androidmobilestock_bangkok.Menu();
                    break;
            }
