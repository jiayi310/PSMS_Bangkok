...
import com.example.androidmobilestock_bangkok.databinding.PlActivitySodtllistBinding;
import com.example.androidmobilestock_bangkok.databinding.PplActivityPoDownloaddtllistBinding;
import com.example.androidmobilestock_bangkok.databinding.PplActivityPodtllistBinding;

import java.util.ArrayList;
import java.util.List;

public class PPL_PODtlList extends AppCompatActivity {
    PplActivityPodtllistBinding binding;
    ACDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.ppl_activity_podtllist);
        ...
        actionBar.setTitle("Purchase Order Details");
    ...
    public void getData()
    {
        ...
        if(!BatchComparison && !LocationComparison) {
            data = db.getPODtl(docNo);
        }else {
            data = db.getPODtl2(docNo);
        }
    ...
    public class MyClickHandler
    {
        ...
        public void OnbtnSaveClicked(View view)
        {
            if (doDtlList.size()>0) {
                ...
                Toast.makeText(PPL_PODtlList.this, "Please add at least 1 item",
