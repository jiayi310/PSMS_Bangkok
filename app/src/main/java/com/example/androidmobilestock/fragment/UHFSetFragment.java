...
import com.example.androidmobilestock.activity.UHFSecondActivity;
import com.example.androidmobilestock.tools.UIHelper;
...
public class UHFSetFragment extends KeyDwonFragment implements OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btnSetPower = (Button) getView().findViewById(R.id.btnSetPower);
        btnGetPower = (Button) getView().findViewById(R.id.btnGetPower);
        ...
        btnGetPower.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                OnClick_GetPower(view);
            }
        });

        btnSetPower.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
...
//            mContext.playSound(2);
        ...
        rb_America.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                onClick_rbAmerica(view);
            }
        });
...
//			showFrequencyDialog();
        ...
        } else if (id == R.id.btnGetWait) { //获取空占比
            getPwm();
        } else if (id == R.id.btnSetAgreement) { //设置协议
...
//                    mContext.playSound(2);
        ...
        } else if (id == R.id.btnSetQTParams) { //设置QT参数
            if (!cbQt.isChecked()) {
...
//                    mContext.playSound(2);
        ...
        } else if (id == R.id.btnGetQTParams) { //获取QT参数
        ...
        } else if (id == R.id.btnSetLinkParams) { //设置链路参数
...
//                    mContext.playSound(2);
        ...
        } else if (id == R.id.btnGetLinkParams) { //获取链路参数
            getLinkParams();
        } else if (id == R.id.btnSetSession) {// //设置SESSION只针对盘点EPC有效，对返回EPC+TID,EPC+TID+USER无效
