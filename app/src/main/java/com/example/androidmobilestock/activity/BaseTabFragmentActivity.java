...
import com.example.androidmobilestock.adapter.ViewPagerAdapter;
import com.example.androidmobilestock.fragment.KeyDwonFragment;
...
//		mActionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_TABS);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.main_rf, menu);
		return true;
//		return super.onCreateOptionsMenu(menu);
	}

	protected void initViewPager() {
		mViewPagerAdapter = new ViewPagerAdapter(getSupportFragmentManager(), lstFrg);
