...
import com.example.androidmobilestock.fragment.UHFReadTagFragment2;
import com.example.androidmobilestock.widget.NoScrollViewPager;
 ...
 * 更新于 2016年8月9日
 */
public class UHFSecondActivity extends BaseTabFragmentActivity {
...
//	}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.wtf("Intent Start:","UHFSecondACTIVITY");

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("RFID Scan");
        ...
        Log.wtf("Fragment Second Activity",st.getDocNo());
        Log.wtf("StockDetailList Length", String.valueOf(st.StockDetailListLength()));

//        UHFReadTagFragment fg1 = new UHFReadTagFragment();
...
//			appContext = (AppContext) getApplication();
    ...
    protected void initViewPageData() {
        ...
        lstFrg.add(new UHFReadTagFragment2());
    ...
    public void onBackPressed() {
        ...
        newIntent.putExtra("STHeader",st_temp);
    ...
    public class InitTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                Toast.makeText(UHFSecondActivity.this, "init fail",
        ...
        protected void onPreExecute() {
            ...
            mypDialog = new ProgressDialog(UHFSecondActivity.this);
