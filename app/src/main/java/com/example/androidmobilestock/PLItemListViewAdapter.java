...
import com.example.androidmobilestock.databinding.RowPlitemListBinding;
import com.example.androidmobilestock.databinding.RowPplitemListBinding;
...
public class PLItemListViewAdapter extends BaseAdapter {
    ...
    PLItemListViewAdapter(Context context, List<AC_Class.Item> item_list) {
