...
import com.example.androidmobilestock.databinding.PlActivityCompareBinding;
import com.example.androidmobilestock.databinding.PplActivityCompareBinding;

import java.util.ArrayList;
import java.util.List;

public class PPL_Compare extends AppCompatActivity {

    PplActivityCompareBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.ppl_activity_compare);

        db = new ACDatabase(PPL_Compare.this);
        packingList = getIntent().getParcelableExtra("iPackingList");
        typeFP = getIntent().getStringExtra("iType");

        handler = new PPL_Compare.MyClickHandler(this);
        binding.setHandler(handler);

        ActionBar actionBar = getSupportActionBar();
        try {
            actionBar.setTitle("Purchase List Summary");
            actionBar.setDisplayHomeAsUpEnabled(true);
            actionBar.setBackgroundDrawable(new ColorDrawable(0xFFbe5504));
        } catch (Exception e) {
            Log.i("custDebug", "Purchase List Summary: " + e.getMessage());
        }
    ...
    private void getData() {
        if (packingList != null) {
            ...
            PL_CompareListViewAdapter adapter = new PL_CompareListViewAdapter(PPL_Compare.this,
                    mySODODtlList);
    ...
    public class MyClickHandler {
        ...
        public void OnbtnSaveClicked(View view) {
            ...
            if (!binding.tvTally.getText().equals("TALLY")) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(PPL_Compare.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (packingList != null) {
                            db.savePurPackingList(packingList, typeFP);
