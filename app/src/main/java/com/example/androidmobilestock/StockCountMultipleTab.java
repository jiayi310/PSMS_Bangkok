...
import com.example.androidmobilestock.databinding.ActivityStockCountMultipleTabBinding;
import com.example.androidmobilestock.ui.main.SCBarcodeFragment;
import com.example.androidmobilestock.ui.main.SCManualFragment;
import com.example.androidmobilestock.ui.main.SCSectionsPagerAdapter;
...
public class StockCountMultipleTab extends AppCompatActivity implements SCManualFragment.OnFragmentInteractionListener, SCBarcodeFragment.OnFragmentInteractionListener,SCManualFragment.OnDataPass{
    ...
    int size;
    List<String> _ic = new ArrayList<String>();
    List<String> _dsc = new ArrayList<String>();
    List<String> _loc = new ArrayList<String>();
    List<String> _uom = new ArrayList<String>();
    List<String> _qty = new ArrayList<String>();
